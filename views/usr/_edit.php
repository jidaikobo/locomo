...
<div class="form_group">
	...
	<tr class="<?php echo $form->field('display_name')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('display_name')->set_template('<em class="aria_nd"   hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	<!--
	...
	<tr class="<?php echo $form->field('usergroup')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('usergroup')->set_template('<em class="aria_nd"   hidden="true">{error_msg}</em>{fields} {field} {label}{fields}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	<?php
	//管理者以外は旧パスワードを求める
	if ( ! \Auth::is_admin()): ?>
	<tr class="<?php echo $form->field('old_password')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('old_password')->set_template('<em class="aria_nd" hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	<?php endif; ?>
	<tr class="<?php echo $form->field('password')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('password')->set_template('<em class="aria_nd" hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	...
	<tr class="<?php echo $form->field('created_at')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('created_at')->set_template('<em class="aria_nd" hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	</tr>
	<tr class="<?php echo $form->field('expired_at')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('expired_at')->set_template('<em class="aria_nd" hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	...
	<tr class="<?php echo $form->field('is_visible')->set_template('{error_class}'); ?>">
		...
		<td><?php echo $form->field('is_visible')->set_template('<em class="aria_nd" hidden="true">{error_msg}</em>{field}')->set_attribute('title',"{error_msg}"); ?></td>
	</tr>
	<?php endif; ?>
	</table>
