...
<div id="help_window" class="lcm_floatwindow" style=" display: none;">
	<h1 id="help_title" class="lcmbar_top lcmbar_top_title lcm_floatwindow_title"><a href="javascript:$(function(){show_help(true)});void(0);" tabindex="0" id="help_title_anchor" class="has_accesskey" >ヘルプ<span class="accesskey">(H)</span></a></h1>
	<div id="help_txt">
