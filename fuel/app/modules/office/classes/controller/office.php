<?php
namespace Office;
/*abstract*/ class Controller_Office extends \Locomo\Controller_Crud
{
	//trait
...
//	use \Revision\Traits_Controller_Revision;
	...
	public function action_index_admin() {
		...
		$controller = strtolower(str_replace('Controller_', '', \Inflector::denamespace(\Request::main()->controller)));
