<?php
namespace Wftest;
class Actionset_Base_Wftest extends \Actionset_Base
{
//	use \Revision\Traits_Actionset_Base_Revision;
	...
	*/
	...
	{
		if($id):
			$actions = array(array("wftest/sample_action/".$id, '閲覧'));
			$urls = static::generate_anchors('wftest', 'sample_action', $actions, $obj, ['view','create']);
		endif;
