...
<div class="form_group">
	<table>
	<tr class="<?php echo $form->field('user_name')->set_template('{error_class}'); ?>">
		<th><?php echo $form->field('user_name')->set_template('{label}{required}'); ?></th>
		<td><?php echo $form->field('user_name')->set_template('<span class="aria_nd" hidden="true">{error_msg}</span>{field}')->set_attribute('data-jslcm-tooltip',"{error_msg}"); ?></td>
	</tr>
