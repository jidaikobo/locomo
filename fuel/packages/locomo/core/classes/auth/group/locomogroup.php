...
class Auth_Group_Locomogroup extends \Auth_Group_Driver
{
	...
	{
//		static::$_valid_groups = array_keys(\Config::get('locomoauth.groups', array()));
	}
	...
	public function get_name($group = null)
	{
		...
		return \Config::get('locomoauth.groups.'.$group.'.name', null);
	}
	...
	public function get_roles($group = null)
	{
		...
		$groups = \Config::get('locomoauth.groups');
