<?php
namespace Locomo;
class Model_Format_Pdf_Format extends \Locomo\Model_Base
{

	public static $_target_model = '';
	...
	protected static $_has_many = array(
		'element' => array(
			'key_from' => 'id',
			'model_to' => '\Locomo\Model_Format_Pdf_Element',
			'key_to' => 'format_id',
			'cascade_save' => true,
		...
		'eav' => array(
			'key_from' => 'id',
			'model_to' => '\Locomo\Model_Format_Pdf_Eav',
			'key_to' => 'format_id',
			'cascade_save' => true,
			'cascade_delete' => true,
		),
