<?php
namespace Locomo;
class Controller_Pgfl extends \Locomo\Controller_Base
{
	// traits
...
//	use \Controller_Traits_Revision;
	...
	public static $locomo = array(
		'nicename' => '添付ファイル', // for human's name
		'explanation' => '添付ファイルのコントローラです', // use at admin/admin/home
//		'main_action' => 'index_admin', // main action
		'main_action_name' => '添付ファイル管理一覧', // main action's name
		'main_action_explanation' => '添付ファイルのトップです。', // explanation of top page
		'show_at_menu' => true,  // true: show at admin bar and admin/home
		'order' => 870,   // order of appearance
