<?php
namespace Locomo;
class Controller_Pggrp extends \Locomo\Controller_Base
{
	// traits
...
//	use \Controller_Traits_Revision;
	...
	public static $locomo = array(
		'nicename' => 'カテゴリ', // for human's name
		'explanation' => 'カテゴリのコントローラです', // use at admin/admin/home
//		'main_action' => 'index_admin', // main action
		'main_action_name' => 'カテゴリ管理一覧', // main action's name
		'main_action_explanation' => 'カテゴリのトップです。', // explanation of top page
		'show_at_menu' => true,  // true: show at admin bar and admin/home
		'order' => 860,   // order of appearance
